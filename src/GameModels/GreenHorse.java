...
class GreenHorse extends Horse {

    //set up Start, End, Home, HorseNumber and NestPosition
    public GreenHorse(int horseNum) {
        horseNumber = horseNum;
        color = "green";
        setStartPos(24);
        setHomeArrivalPos(23);
        setHomePos(new int[]{76, 77, 78, 79, 80, 81});
    ...
    public void resetHorse() {
        setNestPos(horseNumber, new int[]{56, 57, 58, 59});
    }
}
