...
public class Player {
    ...
    private String color = "none"; //initially in active so that has color as "none"
    int labelNumber;


    //reset player's values when new game
    public void resetPlayer() {
        color = "none";
        score.resetScore();
    }

    public void setInfo(String name, String color, int labelNumber) {
        this.name = name;
        this.color = color;
    ...
    //set score/name label number in the view
    public int getScoreLabelNum() {
        return labelNumber;
    }

    //set player's color as text
    ...
    //player gains/loses some scores
    public void updateScore(String scoreType) {
        score.updateScore(scoreType);
    }

    //player gains some scores for enter home
